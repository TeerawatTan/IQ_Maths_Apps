...
import 'package:iq_maths_apps/screens/home.dart';
import 'package:iq_maths_apps/screens/lower_copy.dart';
      ...
      onGenerateRoute: (settings) {
        if (settings.name == '/Lower') {
          ...
          return MaterialPageRoute(
            builder: (_) => LowerScreenTest(setting: mathsSetting),
          );
          // if (settings.name == '/Lower') {
          //   final mathsSetting = settings.arguments as MathsSetting;
          //   return MaterialPageRoute(
          ...
          return MaterialPageRoute(
            builder: (_) => HomeScreen(userId: currentUser!.uid),
          );
          // }
