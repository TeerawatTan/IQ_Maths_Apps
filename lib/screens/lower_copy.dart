...
import 'package:iq_maths_apps/widgets/wrapper_body.dart';

class LowerScreenTest extends StatefulWidget {
  final MathsSetting setting;

  const LowerScreenTest({super.key, required this.setting});

  @override
  State<LowerScreenTest> createState() => _LowerScreenTestState();
}

class _LowerScreenTestState extends State<LowerScreenTest> {
